...
//                     <form id="filter1" type="email" ref={contactRef}  >
//                         <br />
//                         {/* <div id=do"> */}
...
export const Filter = ({ setEmailList }) => {
    ...
    const handleSearch = async () => {
        ...
        if ((domain.trim().length === 0) && (district.trim().length === 0) && (city.trim().length === 0)) {
            setError("חובה להכניס לפחות ערך אחד")
            navigate('/filter')
            return
        }
            ...
            <div className="img" >
                ...
                <div className="container">
                    ...
                    <form id="filter1" type="email" ref={contactRef} required >
                        ...
                        <br />
                        <select name="sarea" id="sarea" value={district} onChange={(e) => setDistrict(e.target.value)} required>
                            <option value="" disabled selected>בחר מחוז</option>
                            <option value="דרום">דרום</option>
                            <option value="ירושלים">ירושלים</option>
                            <option value="מרכז">מרכז</option>
                        ...
                        <br />
                        <select name="scity" id="scity" value={city} onChange={(e) => setCity(e.target.value)} required>
                            <option value="" disabled selected>בחר עיר</option>
                            <option value="אום אל פחם">אום אל פחם</option>
                            <option value="אופקים">אופקים</option>
                            <option value="אור יהודה">אור יהודה</option>
